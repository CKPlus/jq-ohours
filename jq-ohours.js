...
(function ($) {
	...
	$.oHours = function(el, options) {
    	...
    	methods = {
	      init: function() {
	      	...
	      	var renderTable = function($oHours) {
	      		var tableTmpl = '<table class="table ohours-table"><tbody></tbody><input type="hidden" name="ohours" value=""></table>';
	      	...
	      	var renderTimeInput = function($oHours) {
	      		
	      		$oHours.append('<select id="start-hour" class="form-control opening-hour-input"></select><span>:</span>');
	      		$oHours.append('<select id="start-min" class="form-control opening-hour-input"></select><span>-</span>');
	      		$oHours.append('<select id="end-hour" class="form-control opening-hour-input"></select><span>:</span>');
	      		$oHours.append('<select id="end-min" class="form-control opening-hour-input"></select>');
	      	...
	      	var renderOpPanel = function($oHours){
	      		$oHours.append('<div class="oh-opration"><button type="button" class="btn btn-default" id="add-daytime-btn">Add</button>');
	      	}($oHours)
	      }
	    }
	    ...
	    $(document).on('click', '#add-daytime-btn', function () {
	    	var checked = [];

		    $('input[name="weekday"]:checked').each(function(k,v){
		      checked.push($(v).val())
		    });
